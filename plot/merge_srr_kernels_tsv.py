...
Usage:
    python merge_srr_kernels_tsv.py <TSV_1> <LABEL_1> [<TSV_2> <LABEL_2> ...] [--output=merged_srr_vs_kernels_per_sec.png]
"""
...
def main():
    ...
    parser.add_argument("--output", default="merged_srr_vs_kernels_per_sec.png", help="Path to save the resulting plot.")
