@REM python .\plot_srr_vs_kernels_per_sec.py C:\Users\Edwin\Documents\TIMIT16kHz\TEST ../ResultsNORMAL/epoch_6.jld2 --name normal_on_timit
@REM python .\plot_srr_vs_kernels_per_sec.py C:\Users\Edwin\Documents\TIMIT16kHz\TEST ../ResultsVOICED/epoch_6.jld2 --name voiced_on_timit
